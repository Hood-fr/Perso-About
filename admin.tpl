...
{if isset ($gestA)}
	<form method="post" >
	 <fieldset id="mainConf">
			<span class="property">
				<label for="ppaperso">{'ppa_perso'|@translate}</label><br><br>
			</span>
			<textarea rows="5" cols="50" {if $useED==1}placeholder="{'Use Extended Description tags...'|@translate}"{/if} class="description" name="perso_about" id="perso_about">{$gestA.PPABASE}</textarea>
  <p>
